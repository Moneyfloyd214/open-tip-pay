...
`;
function injectFallback(el, msg = "Loading app…") {
  el.innerHTML = `
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "Having trouble connecting… Tap to try again."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
  ...
  defaultOptions: {
    queries: {
      retry: (failureCount, error) => {
        ...
        if (msg.includes("CANISTER_ID") || msg.includes("not set") || msg.includes("canister-not-configured") || msg.includes("undefined") || msg.includes("Invalid canister")) {
          return false;
        }
...
(async () => {
  ...
  try {
    ReactDOM.createRoot(rootEl).render(
      /* @__PURE__ */ jsxRuntimeExports.jsx(AppErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FinalApp, {}) }) })
    );
    clearTimeout(renderDeadlineTimer);
  } catch (err) {
